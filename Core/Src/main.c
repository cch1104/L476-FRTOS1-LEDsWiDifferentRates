...
/* USER CODE BEGIN Header_StartLEDMTask */
/**
* @brief Function implementing the LEDMTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartLEDMTask */
void StartLEDMTask(void *argument)
{
  /* USER CODE BEGIN StartLEDMTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
...
/* USER CODE BEGIN Header_StartLEDFTask */
/**
* @brief Function implementing the LEDFTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartLEDFTask */
void StartLEDFTask(void *argument)
{
  /* USER CODE BEGIN StartLEDFTask */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
